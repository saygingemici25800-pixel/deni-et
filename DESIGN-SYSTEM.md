...
- **Güven şeridi:** koyu zemin üstünde büyük rakamlar (`1980`, `40+`), brass etiketler.
...
- Sayfa açılışı: hero'da kademeli beliriş (stagger, 60–90ms gecikmelerle).
- Scroll reveal: 16px aşağıdan + fade, 500ms, yumuşak easing (cubic-bezier(.2,.6,.2,1)).
- Görsel hover: yavaş zoom. Buton hover: 2px yukarı + gölge.
- `prefers-reduced-motion`: tüm animasyonlar kapanır. Asla bounce/abartı yok.
