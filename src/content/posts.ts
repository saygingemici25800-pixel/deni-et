...
const ru: Post[] = [
  {
    ...
    body: [
      ...
      {
        type: 'p',
        text: 'Огузок — кострец, оковалок, ссек — отруб для жаркого, бифштекса и дёнера. Постный, с выраженным волокном. Среднее приготовление и тонкая нарезка делают его изящным; нарежете толсто и поспешите — останется сухим.',
      },
      {
        type: 'p',
