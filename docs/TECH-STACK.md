...
| Animasyon | **Motion (Framer Motion)** + **Lenis** (yumuşak scroll) | Scroll reveal + stagger + inertia; doz: abartısız premium + 1-2 imza (MOTION.md); reduced-motion saygılı. Faz 4'te eklenir. |
